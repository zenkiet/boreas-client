...
- Content routes chain `serverConfiguredGuard` then `authenticatedGuard`. `/login` is chromeless like onboarding; the welcome flow's connect step now lands on it.
